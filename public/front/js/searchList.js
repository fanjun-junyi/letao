/*
* @Author: fanjun-junyi
* @Date:   2017-11-13 20:52:01
* @Last Modified by:   Administrator
* @Last Modified time: 2017-11-14 19:19:40
*/
...
$(function(){
  ...
  $('.lt_search button').on('click',function(){
    ...
    //点击搜索的时候，需要清空排序的条件
    $(".lt_sort a").removeClass('now').find('span').removeClass('fa-angle-up').addClass('fa-angle-dowm');
  ...
  //如果当前a标签没有now这个类，让当前a标签添加上这个类，同时移除其他a标签now这个类，
  //并且让所有的a标签的箭头都向下
